...
def k_watanabe(lwl: float, bwl: float, Tc: float, block_coefficient: float) -> float:
    r"""Watanabe estimate of the k factor as defined in Resistance and Wake Prediction
...
def hoerner(thickness_to_chord: float) -> float:
    r"""Hoerner form factor for a foil from thickness to chord ratio of 2D foil section"""
