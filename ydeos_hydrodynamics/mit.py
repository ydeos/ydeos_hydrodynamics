...
def _get_hull_residuary_resistance_mit_interpolator(Vc: float,
    ...
    froude_numbers_table = [0.00, 0.1370668, 0.2056002, 0.2741336, 0.342667,
                            0.4112004, 0.4797338, 0.5482672, 0.6168006]
    ...
    for i, _ in enumerate(froude_numbers_table):
...
def hull_residuary_resistance_mit(boatspeed: float,
    ...
    interp = _get_hull_residuary_resistance_mit_interpolator(Vc,
                                                             lwl,
                                                             bwl,
                                                             Tc,
                                                             rho_water)
