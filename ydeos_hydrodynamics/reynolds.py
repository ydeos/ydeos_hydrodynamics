...
def reynolds_number(speed: float,
    ...
    """Reynolds number from flow speed [m/s], dimension [m] and kinematic viscosity [m2/s].
...
def transition_x(speed: float,
    ...
    speed [m/s]
    transition_reynolds_number is the Reynolds number at which the transition from laminar to turbulent
    is expected to occur
    kinematic_viscosity defaults to kinematic viscosity of water at 20°C : 1,004*10E-6 (m2/s) at 20°C [m**2/s]
