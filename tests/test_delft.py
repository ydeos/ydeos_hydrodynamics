...
def test_memoizing_keel_residuary_ks():
    ...
    t0 = time()
    _ = keel_residuary_ks(boatspeed=1., Vc=0.004, Vk=0.00004, Tc=0.06, T=0.4,
                          lwl=1.0, bwl=0.21, Zcbk=0.15)
    t1 = time()
    _ = keel_residuary_ks(boatspeed=2., Vc=0.004, Vk=0.00004, Tc=0.06, T=0.4,
                          lwl=1.0, bwl=0.21, Zcbk=0.15)
    t2 = time()
    second_call = t2 - t1
    first_call = t1 - t0
...
def test_known_value_hull_residuary_delta_heeled_ks():
    r"""No know data if heel is not 0."""
    assert hull_residuary_delta_heeled_ks(boatspeed=10.,
                                          heel_angle=0.,
                                          Vc=0.004,
                                          lwl=1.0,
                                          bwl=0.2,
...
def test_negative_lwl_hull_residuary_delta_heeled_ks():
    r"""Negative lwl."""
    with pytest.raises(ValueError):
        hull_residuary_delta_heeled_ks(boatspeed=10.,
                                       heel_angle=0.,
                                       Vc=0.004,
                                       lwl=-1.0,
                                       bwl=0.2,
...
def test_resistance_sign_and_symmetry_hull_residuary_delta_heeled_ks():
    ...
    force = hull_residuary_delta_heeled_ks(boatspeed=4.,
                                           heel_angle=30.,
                                           Vc=0.004,
                                           lwl=1.0,
                                           bwl=0.2,
                                           Tc=0.06)
    force_backwards = hull_residuary_delta_heeled_ks(boatspeed=-4.,
                                                     heel_angle=30.,
                                                     Vc=0.004,
                                                     lwl=1.0,
                                                     bwl=0.2,
    ...
    force_heeled_to_windward = hull_residuary_delta_heeled_ks(boatspeed=4.,
                                                              heel_angle=-30.,
                                                              Vc=0.004,
                                                              lwl=1.0,
                                                              bwl=0.2,
...
def test_known_value_hull_residuary_resistance_2008():
    r"""Test against known values."""
    assert hull_residuary_resistance_2008(boatspeed=3.47,
                                          Vc=7.63,
                                          lwl=10.02,
                                          bwl=3.17,
                                          Tc=0.57,
